        ...
        @if($photos->count() > 0)
            ...
            <div class="category-filters-mobile">
                ...
                @foreach($categories as $cat)
                    ...
                    <button class="filter-btn-mobile {{ $category == $cat ? 'active' : '' }}" data-category="{{ $cat }}">
                ...
                <div class="main-viewer-container">
                    <div class="main-viewer">
                        ...
                        <div class="viewer-info">
                            <span class="viewer-category" id="viewerCategory"></span>
                            <span class="viewer-counter" id="viewerCounter">1 de {{ $photos->count() }}</span>
                        </div>
                    </div>
                </div>
            </section>
